...
export default function AddForm(props) {
    ...
    const { AddFormVisible, setAddFormVisible, formdata, loading, handlesave, handleupdate, handlechange } = props;

    return (
        <Dialog header="Add New Leads" visible={AddFormVisible}  onHide={() => setAddFormVisible(false)} className="!w-full lg:!w-[30rem]">
