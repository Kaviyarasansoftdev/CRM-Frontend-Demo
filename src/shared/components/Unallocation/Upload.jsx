...
export default function UploadForm(props) {
    ...
    const { UploadVisible, setUploadVisible, handleupload, loading, uploadfile, progress } = props;

    return (
        <Dialog header="Upload Leads" visible={UploadVisible}  onHide={() => setUploadVisible(false)} className="!w-full lg:!w-[30rem]">
